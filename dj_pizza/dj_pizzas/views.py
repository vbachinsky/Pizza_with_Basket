...
class UpdateOrder(UpdateView):
	...
	def get_context_data(self, **kwargs):
		...
		print('TESTTTTTT', InstancePizza.objects.all().filter(order_template__user=self.request.user))
#		print('TESTTTTTT', InstancePizza.objects.all().filter(order_template__id=1))
		return context
	...
	def form_valid(self, form):
		...
		curent_order.change_order_price()
		print('PRICE3', curent_order.price, curent_order.id)
